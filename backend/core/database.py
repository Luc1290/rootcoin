...
_INDEXES = [
    ...
    "CREATE INDEX IF NOT EXISTS ix_notif_logs_created ON notification_logs (created_at)",
    "CREATE INDEX IF NOT EXISTS ix_notif_logs_type ON notification_logs (type)",
]
